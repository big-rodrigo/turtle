package turtle.conversation.api;
...
import turtle.conversation.api.dto.MessageResponse;
import turtle.conversation.api.dto.SendMessageRequest;
import turtle.conversation.application.ConversationApplicationService;
...
public class ConversationResource {
    ...
    public List<MessageResponse> list(@PathParam("bookingId") Long bookingId) {
        ...
        return conversationService.listMessages(bookingId, userId).stream()
    ...
    public Response send(@PathParam("bookingId") Long bookingId, @Valid SendMessageRequest req) {
        Long userId = Long.parseLong(identity.getPrincipal().getName());
        ChatMessage msg = conversationService.sendMessage(bookingId, userId, req.content());
